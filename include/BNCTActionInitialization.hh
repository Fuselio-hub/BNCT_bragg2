...
#ifndef BNCTActionInitialization_h
#define BNCTActionInitialization_h 1
...
class BNCTActionInitialization : public G4VUserActionInitialization
{
  public:
    BNCTActionInitialization(/*BNCTDetectorConstruction*/);
    virtual ~BNCTActionInitialization();
