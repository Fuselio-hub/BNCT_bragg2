...
#ifndef BNCTAnalysisFileMessenger_h
#define BNCTAnalysisFileMessenger_h 1


#include "G4UImessenger.hh"
#include "globals.hh"

class BNCTAnalysis; ///< Provides SetanalysisFileName()
 ...
 * 
 * @see BNCTAnalysisManager
 */
class BNCTAnalysisFileMessenger: public G4UImessenger
{
public:
  BNCTAnalysisFileMessenger(BNCTAnalysis*);
  ~BNCTAnalysisFileMessenger();
  ...
  BNCTAnalysis* AnalysisManager; ///< handle to AnalysisManager
