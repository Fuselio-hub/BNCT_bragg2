...
#ifndef BNCTDetectorHit_h
#define BNCTDetectorHit_h 1
...
class BNCTDetectorHit : public G4VHit
{
public:
  BNCTDetectorHit();
  BNCTDetectorHit(const BNCTDetectorHit&);
  virtual ~BNCTDetectorHit();
 
 
  const BNCTDetectorHit& operator=(const BNCTDetectorHit&);
 
  G4bool operator==(const BNCTDetectorHit&) const;
...
typedef G4THitsCollection<BNCTDetectorHit> BNCTDetectorHitsCollection;
//******************************MT
extern G4ThreadLocal G4Allocator<BNCTDetectorHit>* BNCTDetectorHitAllocator;
//******************************MT

inline void* BNCTDetectorHit::operator new(size_t)
{
 
  
 if(!BNCTDetectorHitAllocator) 
  BNCTDetectorHitAllocator= new G4Allocator<BNCTDetectorHit>;
 void *aHit;

 aHit = (void *) BNCTDetectorHitAllocator->MallocSingle();
 return aHit;

}

inline void BNCTDetectorHit::operator delete(void *aHit)
{
if(!BNCTDetectorHitAllocator) 
  BNCTDetectorHitAllocator= new G4Allocator<BNCTDetectorHit>;

BNCTDetectorHitAllocator->FreeSingle((BNCTDetectorHit*) aHit);
}
