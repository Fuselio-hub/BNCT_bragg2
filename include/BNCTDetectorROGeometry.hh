...
//
//
#ifndef BNCTDetectorROGeometry_h
#define BNCTDetectorROGeometry_h 
...
class BNCTDetectorROGeometry : public G4VUserParallelWorld
{
public:
  BNCTDetectorROGeometry(G4String);
  ~BNCTDetectorROGeometry();
