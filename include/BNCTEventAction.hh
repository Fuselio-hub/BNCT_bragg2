...
#ifndef BNCTEventAction_h
#define BNCTEventAction_h 1

#include "G4UserEventAction.hh"
#include "globals.hh"

class BNCTMatrix;
class BNCTEventActionMessenger;

class BNCTEventAction : public G4UserEventAction
{
public:
  BNCTEventAction();
  ~BNCTEventAction();
...
private: 
  ...
  //BNCTMatrix *matrix; 
  G4int printModulo;  
  BNCTEventActionMessenger* pointerEventMessenger;
};
