...
#ifndef BNCTInteractionParameters_H
#define BNCTInteractionParameters_H 1
...
class BNCTParameterMessenger; 
class G4ParticleDefinition;
class G4Material;

class BNCTInteractionParameters : public G4EmCalculator 
{
public:

  BNCTInteractionParameters(G4bool);
  ~BNCTInteractionParameters();
...
private:
  ...
  BNCTParameterMessenger* pMessenger; 
  bool beamFlag;
