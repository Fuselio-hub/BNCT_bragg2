...
{
private:
    BNCTLet(BNCTDetectorConstruction*);
    
public:
    ~BNCTLet();
    static BNCTLet* GetInstance(BNCTDetectorConstruction*);
    static BNCTLet* GetInstance();
...
private:
    static BNCTLet *instance;
    BNCTPrimaryGeneratorAction* pPGA;
    // Detector material
