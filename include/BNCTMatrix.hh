...
class BNCTAnalysisFileMessenger;
...
public:
     ...
     */
    static BNCTAnalysis* GetInstance();
    
    
    
    static BNCTAnalysis* instance;
    BNCTAnalysisFileMessenger* fMess;
...
{
private:
  BNCTMatrix(G4int numberOfVoxelAlongX, 
...
public:
  ...
  static BNCTMatrix* GetInstance();
  // Make & Get instance
  static BNCTMatrix* GetInstance(G4int nX, G4int nY, G4int nZ, G4double mass);
