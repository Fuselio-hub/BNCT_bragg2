...
public:
    ...
    static BNCTRBE* CreateInstance(G4int nX, G4int nY, G4int nZ, G4double massOfVoxel);
    static BNCTRBE* GetInstance();
    ...
    // (To be used from BNCTRBEAccumulable)
...
private:
    BNCTRBE(G4int numberOfVoxelX, G4int numberOfVoxelY, G4int numberOfVoxelZ, G4double massOfVoxel);

    G4GenericMessenger* fMessenger;
    G4Pow* g4pow = G4Pow::GetInstance();

    static BNCTRBE* instance;
