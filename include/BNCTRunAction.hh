...
#ifndef BNCTRunAction_h
#define BNCTRunAction_h 1
...
class G4Run;
class BNCTAnalysisManager;
class BNCTDetectorConstruction;
class BNCTRunMessenger;
class BNCTFactory;

class BNCTRunAction : public G4UserRunAction
{
public:
  BNCTRunAction();
  ~BNCTRunAction();
...
private:  
  ...
  BNCTRBEAccumulable fRBEAccumulable;
};
#endif
