...
#include "BNCTDummySD.hh"
#include "BNCTDetectorSD.hh"

/////////////////////////////////////////////////////////////////////////////
BNCTDetectorROGeometry::BNCTDetectorROGeometry(G4String aString)
...
void BNCTDetectorROGeometry::Initialize(G4ThreeVector pos,
...
void BNCTDetectorROGeometry::UpdateROGeometry()
{
  //Nothing happens if the RO geometry is not built. But parameters are properly set.
  if (!isBuilt)
    {
      //G4Exception("BNCTDetectorROGeometry::UpdateROGeometry","had001",
  ...
  RODetector->SetXHalfLength(halfPhantomSizeX);
  RODetector->SetYHalfLength(halfPhantomSizeY);
  RODetector->SetZHalfLength(halfPhantomSizeZ);
...
/////////////////////////////////////////////////////////////////////////////
BNCTDetectorROGeometry::~BNCTDetectorROGeometry()
{;}

/////////////////////////////////////////////////////////////////////////////
void BNCTDetectorROGeometry::Construct()
{
  ...
  if (!isInitialized)
    {
      G4Exception("BNCTDetectorROGeometry::Construct","had001",
  ...
  G4VPhysicalVolume *RODetectorPhys = new G4PVPlacement(0,
    ...
    green = new G4VisAttributes(G4Colour(0/255., 255/255. ,0/255., 1.));
    green -> SetVisibility(false);
    green -> SetForceSolid(true);
    green -> SetForceWireframe(true);
    RODetectorLog -> SetVisAttributes(green);
...
void BNCTDetectorROGeometry::ConstructSD()
{
 G4String sensitiveDetectorName = "RODetector";
 
 BNCTDetectorSD* detectorSD = new BNCTDetectorSD(sensitiveDetectorName);
