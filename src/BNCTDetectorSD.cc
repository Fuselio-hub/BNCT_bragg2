...
{
    G4String HCname;
    collectionName.insert(HCname="BNCTDetectorHitsCollection");
    HitsCollection = NULL;
...
/////////////////////////////////////////////////////////////////////////////
BNCTDetectorSD::~BNCTDetectorSD()
{}

/////////////////////////////////////////////////////////////////////////////
void BNCTDetectorSD::Initialize(G4HCofThisEvent*)
{
...
/////////////////////////////////////////////////////////////////////////////
G4bool BNCTDetectorSD::ProcessHits(G4Step* aStep, G4TouchableHistory* )
{
    ...
    BNCTLet* let = BNCTLet::GetInstance();
    
    G4int* hitTrack = matrix -> GetHitTrack(i,j,k);
    
    
    //  ******************** let ***************************
    if (let)//il metodo per calcolare il let va bene solo per particelle cariche
    {
    ...
    if (matrix)
    {
        ...
        if(energyDeposit != 0)
        {
             ...
             *  A method of the BNCTMatrix class (StoreDoseFluenceAscii())
    ...
    if (rbe->IsCalculationEnabled())
    {
        if (!fRBEAccumulable)
        {
            fRBEAccumulable = dynamic_cast<BNCTRBEAccumulable*>(G4AccumulableManager::Instance()->GetAccumulable("RBE"));
            if (!fRBEAccumulable)
            {
                G4Exception("BNCTDetectorSD::ProcessHits", "NoAccumulable", FatalException, "Accumulable RBE not found.");
            }
        }
...
/////////////////////////////////////////////////////////////////////////////
void BNCTDetectorSD::EndOfEvent(G4HCofThisEvent* HCE)
{
