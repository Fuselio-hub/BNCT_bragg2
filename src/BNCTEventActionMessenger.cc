...
/////////////////////////////////////////////////////////////////////////////
BNCTEventActionMessenger::BNCTEventActionMessenger(BNCTEventAction* EvAct)
:eventAction(EvAct)
{
...
/////////////////////////////////////////////////////////////////////////////
BNCTEventActionMessenger::~BNCTEventActionMessenger()
{
  delete DrawCmd;
  delete PrintCmd;
  delete eventDir;         
...
/////////////////////////////////////////////////////////////////////////////
void BNCTEventActionMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{ 
  if(command == DrawCmd)
