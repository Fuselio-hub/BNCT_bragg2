...
BNCTInteractionParameters::BNCTInteractionParameters(G4bool wantMessenger): 
...
{
    if (wantMessenger) pMessenger = new BNCTParameterMessenger(this); 
}

BNCTInteractionParameters::~BNCTInteractionParameters()
{
...
G4double BNCTInteractionParameters::GetStopping (G4double ene, 
...
bool BNCTInteractionParameters::GetStoppingTable(const G4String& vararg)
{
	// Check arguments
...
G4Material* BNCTInteractionParameters::GetNistMaterial(G4String mat)
{
...
bool BNCTInteractionParameters::ParseArg(const G4String& vararg)
{
...
void BNCTInteractionParameters::BeamOn()
{
...
void BNCTInteractionParameters::ListOfNistMaterials(const G4String& vararg)
{
/*
