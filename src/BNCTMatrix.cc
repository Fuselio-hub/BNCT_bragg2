...
BNCTAnalysis* BNCTAnalysis::instance = 0;
/////////////////////////////////////////////////////////////////////////////

BNCTAnalysis::BNCTAnalysis()
{
    fMess = new BNCTAnalysisFileMessenger(this);
}
...
/////////////////////////////////////////////////////////////////////////////
BNCTAnalysis* BNCTAnalysis::GetInstance(){
...
BNCTMatrix* BNCTMatrix::GetInstance()
{
    return instance;
}
...
BNCTMatrix* BNCTMatrix::GetInstance(G4int voxelX, G4int voxelY, G4int voxelZ, G4double mass)
{
    if (instance) delete instance;
    instance = new BNCTMatrix(voxelX, voxelY, voxelZ, mass);
    instance -> Initialize();
    return instance;
}

/////////////////////////////////////////////////////////////////////////////
BNCTMatrix::BNCTMatrix(G4int voxelX, G4int voxelY, G4int voxelZ, G4double mass):
    stdFile("Dose.csv"),
    doseUnit(gray)
{
    ...
    if (matrix)
    {
        G4cout << "BNCTMatrix: Memory space to store physical dose into " <<
                  numberOfVoxelAlongX*numberOfVoxelAlongY*numberOfVoxelAlongZ <<
                  " voxels has been allocated " << G4endl;
    }

    else G4Exception("BNCTMatrix::BNCTMatrix()", "BNCT0005", FatalException, "Can't allocate memory to store physical dose!");
...
/////////////////////////////////////////////////////////////////////////////
G4bool BNCTMatrix::Fill(G4int trackID,
...
void BNCTMatrix::StoreMatrix(G4String file, void* data, size_t psize)
{
    if (data)
    {
...
void BNCTMatrix::StoreFluenceData()
{
    for (size_t i=0; i < ionStore.size(); i++){
...
// messenger commands
// defined in the BNCTAnalysisFileMessenger.cc class file
void BNCTMatrix::StoreDoseFluenceAscii(G4String file)
{
#define width 15L
...
//////////////////////////////////////////////////////////////////////////////
void BNCTMatrix::Fill(G4int i, G4int j, G4int k,
                               G4double energyDeposit)
{
    if (matrix)
