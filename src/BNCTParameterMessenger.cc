...
BNCTParameterMessenger::BNCTParameterMessenger(BNCTInteractionParameters* param)
:pParam(param)
{
...
BNCTParameterMessenger::~BNCTParameterMessenger()
{
	delete paramDir;
	delete dedxCmd;
	delete listCmd;
...
void BNCTParameterMessenger::SetNewValue(G4UIcommand* command, G4String vararg)
{
	if (command == dedxCmd)
	{
