...
BNCTPrimaryGeneratorAction::BNCTPrimaryGeneratorAction() :
  fNewSource(false)
{
    PrimaryGeneratorMessenger = new BNCTPrimaryGeneratorMessenger(this);
...
/////////////////////////////////////////////////////////////////////////////
void BNCTPrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  if(fNewSource==true)
    {
      ...
      if(in.eof())
        {
	  G4Exception("BNCTPrimaryGeneratorAction", "NoParticles", FatalException, "No more particles in the file");
        }
